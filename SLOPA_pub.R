...
# main attributes: age, salary/pension at t0 and one year before,
...
#----------- Part 1: compare models , using caret -------------------
...
library(caret)   ########## 
confusionMatrix(data = todefine_test_set$pred, reference = todefine_test_set$obs) 
## for each model/method


#------------------
## more models are easily added, see 

# http://topepo.github.io/caret/models-clustered-by-tag-similarity.html 

## and ensemble modeling in caret

#---------------------

# discovered the new R-package, with common author, 
# which works even more efficiently:
 so:
